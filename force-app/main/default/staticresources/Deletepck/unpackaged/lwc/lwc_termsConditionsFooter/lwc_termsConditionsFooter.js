...
export default class Lwc_termsConditionsFooter extends LightningElement {
    ...
    label = { 
        ...
        CN: {termsConditions, termsNexus1, termsNexus2, termsNexus3, termsNexus4, termsNexus5, termsNexus6, termsNexus7, 
             termsNexus8, termsNexus9, termsNexus10, termsNexus11, termsNexus12, termsNexus13, termsNexus14_1, termsNexus14_2,
             termsNexus15, termsNexus16, termsNexus17, termsNexus18, termsNexus19, termsNexus20_1, termsNexus20_2, termsNexus21,
             termsNexusTitle1, termsNexusTitle2, termsNexusTitle3, termsNexusTitle4, acceptTerms, continueLabel},

        MX: {termsConditions, termsNexus1, termsNexus2, termsNexus3, termsNexus4, termsNexus5, termsNexus6, termsNexus7, 
             termsNexus8, termsNexus9, termsNexus10, termsNexus11, termsNexus12, termsNexus13, termsNexus14_1, termsNexus14_2,
             termsNexus15, termsNexus16, termsNexus17, termsNexus18, termsNexus19, termsNexus20_1, termsNexus20_2, termsNexus21,
             termsNexusTitle1, termsNexusTitle2, termsNexusTitle3, termsNexusTitle4, acceptTerms, continueLabel},
            ...
            .then((value) => {
                ...
                for ( var i = 0; i < sURLVariables.length; i++ ) {
                    ...
                    if (sParameterName[0] === 'c__country') {
                        console.log('sParameterName[0][1]: ' + sParameterName[0] + '/' + sParameterName[1]); 
                    ...
                    if (sParameterName[0] === 'c__language') { 
                        sParameterName[1] === undefined ? 'Not found' : this.lang = sParameterName[1];
                        console.log('EN DECR GET c__language: ' + this.lang);
                    }
                }
                if(this.lang == 'polish') this.filename = 'TermsConditionsFooter' + this.country + this.lang;
                ...
                .then(value => {
                    ...
                    Object.keys(this.label[this.country]).forEach(labeKey => {
                        try {
                            resultado = resultado.replaceAll('label.' + labeKey, this.label[this.country][labeKey]);
                    ...
                    try{
                        resultado = resultado.replaceAll('label.continue', this.label[this.country].continueLabel);
                    } catch(e) { }
                    
                    var element = this.template.querySelector('[data-id="add-to-html"]');
