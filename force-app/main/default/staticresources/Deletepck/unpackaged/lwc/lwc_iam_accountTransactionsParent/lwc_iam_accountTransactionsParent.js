...
export default class Lwc_iam_accountTransactionsParent extends LightningElement {
    ...
    // Sorting attributes 
    sortBookDate = 'desc';          //" type="String" default='desc' description="Attributte to sort the Book date column"/>
    sortCategory = 'desc';          //" type="String" default='desc' description="Attributte to sort the Category column"/>
    sortamount = 'desc';            //" type="String" default='desc' description="Attributte to sort the Category column"/>
    ...
    */
    ...
    doInit(){
        try{
            ...
            console.log('ERROR doInit lwc_iam_accountTransactionsParent: ' + error);
        }
    ...
    decrypt(data) {
        ...
        .then((value) => {
            ...
            getPaginatedMovements({
                ...
                console.log('getPaginatedMovements IAM_TransactionsParent: '+error); // TestError
            });
