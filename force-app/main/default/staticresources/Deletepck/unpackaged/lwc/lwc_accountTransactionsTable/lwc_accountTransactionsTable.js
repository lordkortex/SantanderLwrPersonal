...
export default class Lwc_account_TransactionsTable extends LightningElement {
    ...
    navigateToExtractDetail(transactionRowAux) {
        ...
        var transactionRow = this.transactionresults[transactionRowAux.currentTarget.id];
        ...
        if(this.sourcepage == "globalBalance"){
            var url =
                ...
                "&c__accountCode="+this.accountdetails.accountCode+
                "&c__source="+this.sourcepage+
                "&c__lastUpdate="+!this.isendofday+
                ...
                "&c__countryName="+this.accountdetails.countryName+
                ...
                "&c__isIAM="+this.isiam+
                "&c__accountStatus="+this.accountdetails.status+ 
            ...
            var url =
                ...
                "&c__dates="+JSON.stringify(this.dates)+
                "&c__selectedFilters="+JSON.stringify(this.selectedfilters)+ 
                "&c__accountCodes="+JSON.stringify(this.accountcodestosearch)+
                "&c__accountStatus="+this.accountdetails.status+ 
                "&c__localTransactionCode="+transactionRow.obtTransacBusqueda.ltcCode+
                "&c__localTransactionDescription="+transactionRow.obtTransacBusqueda.ltcDescription+ 
                "&c__transactionBatchReference="+transactionRow.obtTransacBusqueda.transactionBatchReference;
    ...
    get iterationTransactionResults(){
        if(this.transactionresults){
            ...
            var items = new Array();
            var aux = this.transactionresults.slice(this.start,this.end + 1);
