({
					...
					this.decrypt(component,sURLVariablesMain[1]).then(function(results){
						...
						for ( var i = 0; i < sURLVariables.length; i++ ) {
							...
							if (sParameterName[0] === 'c__userId') { 
								...
								component.find("Service").callApex2(component,helper, "c.getUserProfilingInfo", {'userCod' : sParameterName[1]}, helper.setData);
	...
	*/
	...
	getServiceProfilingData : function(component, event, helper) {
		component.find("Service").callApex2(component, helper,"c.getUserProfilingInfo", {}, this.populateServiceProfiling);
	},
