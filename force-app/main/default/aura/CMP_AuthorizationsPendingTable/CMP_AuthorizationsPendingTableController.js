...
*/
({  
    //The following method sets the component attributes with the values of the event attributes to open the accept or reject authorization modal
    openModal : function(component, event, helper) {
        var params = event.getParams();
        
        if(params.showDeletePopup == true){
            component.set("v.title", params.title);
            component.set("v.question", params.question);
            component.set("v.authorizationId", params.idAuthorization);
            component.set("v.showDeletePopup", params.showDeletePopup);
            component.set("v.indexAuthorization", params.indexAuthorization);
            component.set("v.nomAuthorization", params.nomAuthorization);
            component.set("v.stateAuthorization", params.stateAuthorization);
            component.set("v.actionAuthorization", params.actionAuthorization);
            component.set("v.objAuthorization", params.objAuthorization);
        }
    },
    ...
    paginationChange : function(component, event, helper) {
        // Build pagination
        var end;
        var response = component.get("v.pendingAuthorizations");
    ...
    buildTableData : function(component, event, helper){
        try {
            var json = component.get("v.pendingAuthorizations");
