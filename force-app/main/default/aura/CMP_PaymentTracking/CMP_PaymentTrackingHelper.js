({
    getCountryName : function(component, event) {
        ...
        var iTrackingList =  component.get("v.trackingList");
        var trackingCountries = [];
        console.log('>>> payment tarcking size: ' + iTrackingList.length);
        for (var item in iTrackingList) {
            console.log('>>> payment tarcking country: ' + item.country);
        }
    ...
    getDateDifference: function(component, event, helper){
        try{
            ...
            for(var i in item){
			    ...
			    if(item[i].arrival!=null&& item[i].departure!=null){
