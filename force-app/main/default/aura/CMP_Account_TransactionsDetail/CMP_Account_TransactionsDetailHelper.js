            ...
            if (sURLVariablesMain[0] == 'params') {
                this.decrypt(component,sURLVariablesMain[1]).then(function(results){
                    ...
                    for ( var i = 0; i < sURLVariables.length; i++ ) {
                        ...
                        }else if (sParameterName[0] === 'c__creditorAccountDetails') /*&& component.get("v.transactionDetails.transactionType") != undefined && component.get("v.transactionDetails.transactionType") == 'debit')*/ { 
                        ...
                        }else if (sParameterName[0] === 'c__debtorAccountDetails')/*&& component.get("v.transactionDetails.transactionType") != undefined && component.get("v.transactionDetails.transactionType") == 'credit')*/ { 
                            sParameterName[1] === "undefined" ? component.set("v.transactionDetails.accountDetails", {}) : component.set("v.transactionDetails.accountDetails", JSON.parse(sParameterName[1]));
