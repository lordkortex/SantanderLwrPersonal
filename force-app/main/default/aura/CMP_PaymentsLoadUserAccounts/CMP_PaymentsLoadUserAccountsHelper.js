({
  ...
  getRawAccounts: function (component, helper, userData) {
    return new Promise(
      $A.getCallback(function (masterResolve, masterReject) {
        let key = "balanceGP";
        helper.handleRetrieveFromCache(component, helper, key).then(
          $A.getCallback(function (value) {
            if (
              value != null &&
              !$A.util.isEmpty(value.responseAcc.accountList)
            ) {
  ...
  getRawAccountsFiltered: function (component, helper, userData) {
    return new Promise(
      $A.getCallback(function (masterResolve, masterReject) {
        ...
        helper
          .handleRetrieveFromCache(component, helper, key)
          .then(
            $A.getCallback(function (value) {
              if (!$A.util.isEmpty(value)) {
                ...
                helper
                  .getRawAccounts(component, helper, userData) //29-09-2020 - SNJ - invokes getRawAccounts instead of callToAccountsWithAttributions
                  .then(
                    $A.getCallback(function (value) {
                      return helper.discardAccountsByCountry(
                        component,
                        helper,
                        userData,
                        value
                  ...
                  .then(
                    $A.getCallback(function (value) {
                      return helper.handleSaveToCache(
                        component,
                        helper,
                        key,
                        value
  ...
  callToAccountsWithAttributions: function (
    component,
    helper,
    userData,
    transferType
    ...
    return new Promise(
      $A.getCallback(function (masterResolve, masterReject) {
        helper.getRawAccountsFiltered(component, helper, userData).then(
          $A.getCallback(function (value) {
            return helper
              .callToAccountsWithAttributionsParams(component, {
                userData: userData,
  ...
  getAccountsToB2BOrigin: function (component, helper, userData, transferType) {
    return new Promise(
      $A.getCallback(function (masterResolve, masterReject) {
        helper.removeAccountsCacheItems(component, helper).then(
          $A.getCallback(function (value) {
                ...
                $A.getCallback(function (value) {
                  if (!$A.util.isEmpty(value)) {
                    ...
                    helper
                      ...
                      .then(
                        $A.getCallback(function (value) {
                          return helper.filterAccountsToB2BOriginByCountryAndCurrency(
                            component,
                            helper,
                            userData,
                            value
  ...
  /*
	...
	*/
  getAccountsToB2BDestination: function (
    component,
    helper,
    user,
    transferType,
    ...
    return new Promise(
      $A.getCallback(function (masterResolve, masterReject) {
        helper
          .getAccountsToB2BOrigin(component, helper, user, transferType)
          .then(
            $A.getCallback(function (value) {
              return helper
  ...
  callToBeneficiaryAccounts: function (
    component,
    helper,
    userData,
    transferType,
    ...
    return new Promise(
      $A.getCallback(function (resolve, reject) {
        ...
        if (PAY_AccountsCache === "false" || key == "noCache") {
          ...
          let timestamp = window.localStorage.getItem(
            userId + "_" + key + "_timestamp"
          );
          if (key == "balanceGP") {
          ...
          let isFreshData =
            timestamp != "null" &&
            timestamp != undefined &&
            new Date() - new Date(Date.parse(timestamp)) <
      ...
      $A.getCallback(function (resolve, reject) {
        ...
        if (!$A.util.isEmpty(clearCache) && clearCache == "true") {
          ...
          window.localStorage.removeItem(
            userId + "_RawAccountsFiltered_timestamp"
          );
          window.localStorage.removeItem(
            userId +
              "_AccountsToB2BOrigin" +
              $A.get("$Label.c.PTT_instant_transfer")
          );
          window.localStorage.removeItem(
            userId +
              "_AccountsToB2BOrigin" +
          ...
          window.localStorage.removeItem(
            userId +
              "_AccountsToB2BOrigin" +
              $A.get("$Label.c.PTT_international_transfer_multiple")
          );
          window.localStorage.removeItem(
            userId +
              "_AccountsToB2BOrigin" +
  ...
  /*
    ...
    */
  discardAccountsByCountry: function (
    component,
    helper,
    userData,
    accountList
  ...
  /*
    ...
    12/11/2020	    Shahad Naji		    Initial version   
    */
  filterAccountsToB2BOriginByCountryAndCurrency: function (
    component,
    helper,
    userData,
    accountList
