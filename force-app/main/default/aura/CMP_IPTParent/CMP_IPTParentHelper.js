  ...
  getAccountsAndPayments: function (component, event, helper) {
    component
      ...
      .callApex2(
        component,
        helper,
        "c.getAccountsAndPayments",
        {},
        helper.setAccountsAndPayments
      );
  },
      ...
      action.setCallback(this, function (response) {
        ...
        if (state === "SUCCESS") {
          ...
          if (gb == true) {
            ...
            component.get("v.isCashNexus") == false &&
            component.get("v.isBIC") == false
          ) {
            component.set("v.agreedTerms", true);
          }
        ...
        if (state === "ERROR") {
          ...
          if (result != undefined && result != null && result != "") {
            component
              ...
              .redirect(
                "payment-uetr-track",
                "c__comesFromTracker=true&c__uetr=" + result
              );
          }
        }
        resolve(result);
        ...
        this.decrypt(component, sURLVariablesMain[1]).then(function (results) {
          ...
          if (sURLVariables[0] != "") {
            for (var i = 0; i < sURLVariables.length; i++) {
              ...
              if (sParameterName[0] === "c__subsidiaryName") {
                ...
                sParameterName[1] == "true"
                  ? component.set("v.showAccountPayment", true)
                  : component.set("v.showAccountPayment", false);
              } else if (sParameterName[0] === "c__isOneTrade") {
                sParameterName[1] == "true"
                  ? component.set("v.isOneTrade", true)
                  : component.set("v.isOneTrade", false);
              } else if (sParameterName[0] === "c__filters") {
                sParameterName[1] === undefined
                  ? "Not found"
                  : component.set("v.filters", sParameterName[1]);
                ...
                sParameterName[1] === undefined
                  ? "Not found"
                  : component.set("v.fullAccountList", sParameterName[1]);
              }
            }
            ...
            if (component.get("v.fromDetail") == true) {
              var parsedAccounts = JSON.parse(
                component.get("v.fullAccountList")
              );
