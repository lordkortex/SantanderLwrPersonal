    ...
    initComponent: function (component, event, helper) {
        new Promise($A.getCallback(function (resolve, reject) {
            ...
            return helper.getAccountDataAux(component, event, helper);
             ...
             return helper.getPaymentDataFrom(component, event, helper);
        })).then($A.getCallback(function (value){
            return helper.getURLParams(component, event, helper);
        })).then($A.getCallback(function (value){
            return helper.getSignatureMode(component, event, helper);
        })).then($A.getCallback(function (value){
            ...
            component.set('v.paymentId',payment.paymentId);
