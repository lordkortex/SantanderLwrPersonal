({
    ...
    refreshPills : function(component, event, helper) {
        try {
            ...
            var filter="originator_agent=BSCHESM0XXX&account_Id="+component.get("v.accountNumber");
            ...
            if(selectedStatus!=null && selectedStatus!=undefined && selectedStatus.length!=0){            
                ...
                if(selectedStatus.length==1){
                    if(selectedStatus[0]=='Completed'){
                        filter+='ACCC&reason=null';
                    }else if(selectedStatus[0]=='Completed'){
                        filter+='RJCT&reason=null';
                    }else if(selectedStatus[0]=='In progress'){
                        filter+='ACSP&reason=G000';
                    }else{
                        filter+='ACCC&reason=G002';
                    }
    ...
    History
    <Date>			<Author>		<Description>
    11/12/2019		R. Alexander Cervino     Initial version*º/
