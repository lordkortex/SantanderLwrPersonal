({
    completeStep: function (component) {
        return new Promise($A.getCallback(function (resolve, reject) {  
            ...
            if ($A.util.isEmpty(paymentDraft.expensesAccount) || paymentDraft.expensesAccount == paymentDraft.data) {
    ...
    getPaymentId: function (component, helper) {
        return new Promise($A.getCallback(function (resolve, reject) {
            ...
            if (component.get('v.isEditingProcess') == true && !$A.util.isEmpty(paymentDraft.paymentId)) { // revisar funcionalidad del isEditingProcess
                resolve('OK');
