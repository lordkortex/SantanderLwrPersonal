    ...
    doInit : function(component, event, helper) {
        ...
        /*if(filters != undefined && filters.length>0){
            ...
            for(var i = 0; i < filters.length; i++) {
                if (filters[i].name == $A.get("$Label.c.amount")) {
                    console.log(filters[i].selectedFilters.from);
                    console.log(filters[i].selectedFilters.to);
                    component.find('AmountFrom').set("v.value", filters[i].selectedFilters.from);
                    component.find('AmountTo').set("v.value", filters[i].selectedFilters.to);
                }
            }
        }*/
