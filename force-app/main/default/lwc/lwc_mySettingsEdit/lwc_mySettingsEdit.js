...
export default class Lwc_mySettingsEdit extends LightningElement {
    ...
    getCachedInfo(){
        this.template.querySelector('c-lwc_service-component').retrieveFromCache('balanceEODGP', this.saveDataToCacheEOD);
        this.template.querySelector('c-lwc_service-component').retrieveFromCache('balanceGP', this.saveDataToCacheLU);
    }
    saveDataToCacheEOD(){
        ...
        if(response != null){
            ...
            if(parsedResponse != null && parsedResponse.mapUserFormats != null){
                ...
                this.template.querySelector('c-lwc_service-component').saveToCache('balanceEODGP', parsedResponse);
            }
        }
    ...
    saveDataToCacheLU() {
        ...
        if(response != null){
            ...
            if(parsedResponse != null && parsedResponse.mapUserFormats != null){
                ...
                this.template.querySelector('c-lwc_service-component').saveToCache('balanceGP', parsedResponse);
            }
        }
