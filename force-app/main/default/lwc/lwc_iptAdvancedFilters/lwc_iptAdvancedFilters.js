...
export default class Lwc_iptAdvancedFilters extends LightningElement {
    ...
    get accountLabel1() {
        return this.inoutindicator == 'OUT' ? this.label.originAccount : this.label.beneficiaryAccount;
    }

    get accountLabel2() {
        return this.inoutindicator == 'IN' ? this.label.originAccount : this.label.beneficiaryAccount;
    }
    ...
    refreshPills() {
        try {
            ...
            if(currency != null && currency != ""  && currency != this.label.singleChoice){
