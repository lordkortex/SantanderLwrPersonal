...
import cmpOTVContentInformativeList_7 from '@salesforce/label/c.cmpOTVContentInformativeList_7';
import cmpOTVContentInformativeList_8 from '@salesforce/label/c.cmpOTVContentInformativeList_8';
import cmpOTVContentInformativeList_9 from '@salesforce/label/c.cmpOTVContentInformativeList_9';
...
export default class CmpOTVContentInformativeList extends LightningElement {
    ...
    label = {
        ...
        cmpOTVContentInformativeList_7,
        cmpOTVContentInformativeList_8,
        cmpOTVContentInformativeList_9
    }
    ...
    contentInforIlustration_1 = images + '/content-info-list-illustration-1@2x.png';
    contentInforIlustration_2 = images + '/content-info-list-illustration-2@2x.png';
    contentInforIlustration_3 = images + '/content-info-list-illustration-3@2x.png';
    contentInforIlustration_4 = images + '/content-info-list-illustration-4@2x.png';
