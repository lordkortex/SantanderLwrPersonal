...
export default class Lwc_paymentsLandingFilterModal extends LightningElement {
    ...
    setFilter () {
        ...
        if(selectedBox != undefined && selectedBox != null && selectedBox != ''){
            ...
            if(fromDecimal != undefined && fromDecimal != null  && fromDecimal != ''){
                this.setValue(fromDecimal, 'fromAmount');
            }
            var toDecimal = this.todecimal;
            if(toDecimal != undefined && toDecimal != null && toDecimal != ''){
