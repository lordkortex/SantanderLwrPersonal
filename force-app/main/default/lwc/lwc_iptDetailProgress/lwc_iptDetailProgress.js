...
export default class Lwc_iptDetailProgress extends LightningElement {
   ...
   get iObjectStepListLength(){
    ...
    get iObjectStatus(){
        return this._iobject.status != "ACSC" && this._iobject.status != "ACCC" && this._iobject.status != "RJCT";
    }
    ...
    get statusCondition3(){
        return this._iobject.status == "ACSP" && (this._iobject.reason == "G000" || this._iobject.reason == "G001");
    }

    get statusCondition4(){
        return this._iobject.status == "ACSP" && (this._iobject.reason == "G002" || this._iobject.reason == "G003" || this._iobject.reason == "G004");
    }
    ...
    get statusCondition7(){
        return this._iobject.reason == "G002" || this._iobject.reason == "G003" || this._iobject.reason == "G004";
    }
    ...
    buildData(iobject){
        ...
        Object.keys(iobject.stepList).forEach((step,index) => {
            ...
            obj.itemCondition1 = !iobject.stepList[step].arrival && iobject.stepList[step].departure && index < stepListLength-1;
            obj.itemCondition2 = iobject.stepList[step].arrival && iobject.stepList[step].departure;
            obj.itemCondition3 = index != stepListLength-1 && index != stepListLength-2;
