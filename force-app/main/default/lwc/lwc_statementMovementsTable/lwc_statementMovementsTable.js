...
export default class Lwc_statementMovementsTable extends LightningElement {
    ...
    get movementslistNotNull(){
        return this.movementslist == null || this.movementslist === '' || !(this.movementslist.length > 0);
    }
    ...
    navigateToDetail (event) {
        var actualMovement = this.movementslist[event.currentTarget.id].obtTransacBusqueda;
