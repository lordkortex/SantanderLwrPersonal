...
export default class CmpPayRegisterBeneficiary extends LightningElement {
    ...
    @track value1 = {'displayNumber': "", "subsidiaryName": "", "codigoBic": "", "address": {"province": "", "streetName": "", "townName": "", "floor": "", "country": ""}, "idType": "IBA", "country": ""};

    @track value2 = {'displayNumber': "", "subsidiaryName":"", "creditorDocument": {"documentType": "BIC", "documentNumber":""}, "subsidiaryName": "", "address": {"state": "", "streetName": "", "townName": "", "floor": "", "addressAddition": "", "country": ""}, "idType": "IBA", "country": ""};

    @track value3 = {'displayNumber': "", "bankName": "",  "subsidiaryName":"", "branch": "" , "type": "", "creditorDocument": {"documentType": "BIC", "documentNumber":""}, "address": {"state": "", "streetName": "", "townName": "", "floor": "", "addressAddition": "", "country": ""}, "idType": "BBA", "country": ""};
