...
export default class Lwc_newDropdown extends LightningElement {
    ...
    get isNotSingleChoice(){
        if(this.selectedvalue){
            return this.selectedvalue != null && this.selectedvalue != this.label.singleChoice
        }
    }
    ...
    get disabledClass() {
        return this.isdisabled ? 'slds-dropdown slds-dropdown_left slds-dropdown_small dropdownOrder__none disabled' : 'slds-dropdown slds-dropdown_left slds-dropdown_small dropdownOrder';
    }
    get valueLength() {
    ...
    dispatchEventsDropdown(selectedValues) {
        const dropdownvalueselectedevent = new CustomEvent('dropdownvalueselected',{
            detail: { selectedvalues : selectedValues},
        });
        this.dispatchEvent(dropdownvalueselectedevent);
        const dropdownexchangecurrencyevent = new CustomEvent('dropdownexchangecurrency',{
            detail: { selectedvalues : selectedValues},
        });
