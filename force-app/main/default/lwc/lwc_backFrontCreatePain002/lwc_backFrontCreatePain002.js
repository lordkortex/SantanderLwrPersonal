...
export default class Lwc_backFrontCreatePain002 extends LightningElement {
    ...
    @track channelList = ['SwiftNet', 'Editran', 'SFTP','H2H', 'EBICS','Others'];
        ...
        try {
            ...
            .then( result => {
                ...
                if(res != undefined && res != "" && res != [] && res != '""'){
                    ...
                    for(var i in resJSON){
                        ...
                        accounts.push({'account':resJSON[i].iban,'bic':resJSON[i].agent});
                    }
            ...
            .finally( () => {
                ...
                if(this.template.querySelector("[data-id='spinnerCreate']")){
                    this.template.querySelector("[data-id='spinnerCreate']").classList.add("slds-hide");
                }
            });
        } catch (e) {
            console.log(e);
    ...
    add(){
        try {
            if(this.selectedAccount != '' && this.selectedChannel != ''){
                ...
                var body = '{"accountPain002Insert": {"companyGlobalId": "' + this._entity + '","accountId": "' + this.selectedAccount + '","bankId": "' + bic + '","channel": "' + this.selectedChannel + '","periodicity": "daily"}}';
