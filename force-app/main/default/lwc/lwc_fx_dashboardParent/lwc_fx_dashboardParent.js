...
export default class Lwc_fx_dashboardParent extends NavigationMixin(
  LightningElement
) {
    ...
    this.rows = [
      {
        orderScore: "1",
        columnas: [
          { order: "1", type: "standard", value: "row1" },
          { order: "2", type: "status", value: "Draft", status: "001" },
          { order: "3", type: "standard", value: "row3" },
          { order: "4", type: "date", value: "2021-02-01T16:23:23.123+0000" },
          { order: "5", type: "date", value: "2021-02-01T16:23:23.123+0000" },
          { order: "6", type: "amount", value: "50355", currency1: "EUR" },
          { order: "7", type: "counter", value: "13035", currency1: "USD" }
        ]
      },
      {
        orderScore: "2",
        columnas: [
          { order: "1", type: "standard", value: "row1" },
          { order: "2", type: "status", value: "Pending", status: "002" },
          { order: "3", type: "standard", value: "row3" },
          { order: "4", type: "date", value: "2021-02-01T16:23:23.123+0000" },
          { order: "5", type: "date", value: "2021-02-01T16:23:23.123+0000" },
          { order: "6", type: "amount", value: "50355", currency1: "EUR" },
