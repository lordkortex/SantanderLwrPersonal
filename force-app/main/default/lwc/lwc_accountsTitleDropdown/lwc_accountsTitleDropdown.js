...
export default class Lwc_accountsTitleDropdown extends LightningElement {
    ...
    currencies;                                 //" type="List" default="" description="List of values to populate the dropdown" />
    @api selectedcurrency = 'EUR';                           //" type="String" description="Selected option from the dropdown" />
    ...
    upToDate = 'N/A';                           //" type="String" default="N/A" description="Updating date of conversion rates in salesforce"/>
    upToHour = 'N/A';                           //" type="String" default="N/A" description="Updating date of conversion rates in salesforce"/>
    @api iscashnexus;                                //" type="Boolean" default="true" description="True if current user is a Cash Nexus user, else, false"/>
    isocodelist;                                //" type="List" description="A list of available Currency Iso Codes for current logged user"/>
    corporateCurrency;                          //" type="Object" description="Corporate currency"/>
    currencyList;                               //" type="List" description="List of currencies available for current logged user"/>
    ...
    iAccount;                                   //" type="Object" description="Account information"/>
    ...
    upToDateAux = 'N/A';                        //" type="String" default="N/A" description="Updating date of conversion rates in salesforce"/>
    upToHourAux = 'N/A';                        //" type="String" default="N/A" description="Updating date of conversion rates in salesforce"/>
    ...
    currentcurrency;                            //" type="Object" description="Selected currency"/>
    ...
    get isSelectedTime(){
        return this.selectedtimeframe == this.label.currency || this.accountcurrencies == '';
    }
    ...
    exchangeCurrency(currentCurrency, currencyList){
        exchangeCurrency({
            ...
            if (error) {
                console.log("AccountTitleDropDown exchangeCurrency Error message: " + error);
            } else {
    ...
    calculateLatestDate(accountsInfo,isLastUpdate,theUpdate,theUpdateMain){
        if(isLastUpdate){
    ...
    getCurrencyList(currentCurrency){
        ...
        getCurrenciesList({
            ...
            if (error) {
                console.log("AccountTitleDropDown getCurrencyList Error message: " + error);
            } else {
