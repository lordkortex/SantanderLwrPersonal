  ...
  // Expose the labels to use in the template.
   ...
   @track mensajeError = 'textHelp';
    ...
    validateSettled() {
        try{
            this.error=false;
            if(this.settledfrom!=null && this.settledfrom !=undefined && this.settledfrom != ""){
                if(parseInt(this.settledfrom)<0){
                    this.settledfrom = "";
                }
            }
    
            if(this.settledto!=null && this.settledto !=undefined && this.settledto != ""){
                if(parseInt(this.settledto)<0){
                    this.settledto = "";
                }
            }
    
            if(this.settledto!=null && this.settledto !=undefined && this.settledto != "" && this.settledfrom!=null && this.settledfrom !=undefined && this.settledfrom != ""){
    ...
    updatePlaceHolder(){
        this.valueplaceholder = this.label.amount;
        if(this.settledfrom!="" && this.settledfrom!=null && this.settledfrom!=undefined && (this.settledto=='' || this.settledto==null || this.settledto==undefined) ){
            this.settledfrom = this.settledfrom.toLocaleString(lang);
            this.valueplaceholder = amount +' ('+Intl.NumberFormat(locale).format(this.settledfrom)+" - Max)";
        }
        if(this.settledto!="" && this.settledto!=null && this.settledto!=undefined && (this.settledfrom=='' || this.settledfrom==null || this.settledfrom==undefined) ){
            this.settledto = this.settledto.toLocaleString(lang);
            this.valueplaceholder = this.label.amount +' (Min - '+Intl.NumberFormat(locale).format(this.settledto)+")";
        }
        if(this.settledto!=null && this.settledto !=undefined && this.settledto != "" && this.settledfrom!=null && this.settledfrom !=undefined && this.settledfrom != ""){
            this.settledfrom = this.settledfrom.toLocaleString(lang);
            this.settledto = this.settledto.toLocaleString(lang);
            this.valueplaceholder = this.label.amount +' ('+Intl.NumberFormat(locale).format(this.settledfrom)+' - '+Intl.NumberFormat(locale).format(this.settledto)+")";
        }
    
    }

    refreshInput(){
        const updatefilterdropdowninput = new CustomEvent('updatefilterdropdowninput', {
            detail: [{ filter : 'settledTo',  value : this.settledto}, { filter : 'settledFrom',  value : this.settledfrom}],
        });
