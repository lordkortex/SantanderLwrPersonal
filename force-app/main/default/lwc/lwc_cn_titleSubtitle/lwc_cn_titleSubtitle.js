...
export default class Lwc_cn_titleSubtitle extends NavigationMixin(LightningElement) {
    @api title;
    @api subtitle;
  ...
  // END 11/03/2021
    ...
    goBack() {
      if(this.comesfromtracker == false) {
          ...
          var fullaccountlist = this.fullaccountlist;
          var url = "c__filters="+filters+"&c__fromDetail=true"+'&c__allAccounts='+fullaccountlist;
