...
export default class Lwc_iam_accountDetailParent extends LightningElement {
    ...
    handleParams(response){
        ...
        for(var i = 0; i < response.length ; i++) {
            ...
            if (sParameterName[0] === 'c__filters') { 
                sParameterName[1] === undefined ? 'Not found' : accountDetails.filters = sParameterName[1];
            }
            ...
            if (sParameterName[0] === 'c__iRegister') { 
                sParameterName[1] === undefined ? 'Not found' : accountDetails.iRegister = sParameterName[1];
            }
            if (sParameterName[0] === 'c__firstAccountCountryList') { 
                sParameterName[1] === undefined ? 'Not found' : accountDetails.firstAccountCountryList = sParameterName[1];
            }
            if (sParameterName[0] === 'c__firstTAccountCountryList') { 
                sParameterName[1] === undefined ? 'Not found' : accountDetails.firstTAccountCountryList = sParameterName[1];
            }
            ...
            if (sParameterName[0] === 'c__accountGrouping') { 
                sParameterName[1] === undefined ? 'Not found' : accountDetails.iSortSelected = sParameterName[1];
            }
            if (sParameterName[0] === 'c__consolidationCurrency') { 
                sParameterName[1] === undefined ? 'Not found' : accountDetails.iCurrency = sParameterName[1];
            }
            ...
            if (sParameterName[0] === 'c__associatedAccountList') { 
                ...
                Object.keys(accList).forEach(key => {
                    ...
                    accList[key].bankId ? accList[key].isBankIdUndefined = false : accList[key].isBankIdUndefined = true;
                    accList[key].account && accList[key].account.accountId ? accList[key].isAccountUndefined = false : accList[key].isAccountUndefined = true;
                    accList[key].AccountName ? accList[key].isAccountNameUndefined = false : accList[key].isAccountNameUndefined = true;
                    accList[key].bankIdType ? accList[key].isBankIdTypeUndefined = false : accList[key].isBankIdTypeUndefined = true;
                    accList[key].accountAddress ? accList[key].isAccountAddressUndefined = false : accList[key].isAccountAddressUndefined = true;
                    accList[key].account && accList[key].account.accountIdType ? accList[key].isAccountIdTypeUndefined = false : accList[key].isAccountIdTypeUndefined = true;
                    accList[key].AccountName ? accList[key].isAccountNameUndefined = false : accList[key].isAccountNameUndefined = true;
                });
            }
    ...
    navigateToPreviousScreen(){
        ...
        if(sourcePage == "globalBalance"){
            ...
            +"&c__filters="+JSON.stringify(this.accountDetails.filters)
            +"&c__tabs="+this.accountDetails.tabs
            +"&c__sourcePage="+this.accountDetails.sourcePage
            +"&c__iRegister="+JSON.stringify(this.accountDetails.iRegister)
            +"&c__firstAccountCountryList="+JSON.stringify(this.accountDetails.firstAccountCountryList)
            +"&c__firstTAccountCountryList="+JSON.stringify(this.accountDetails.firstTAccountCountryList)
            ...
            var url = "c__source="+aux+"&c__subsidiaryName="+accountDetails.accountName+"&c__accountNumber="+accountDetails.accountNumber
                        ...
                        +"&c__countryName="+accountDetails.countryName+"&c__tabs=true"+"&c__sourcePage="+"&c__comesFrom=accountList"+"&c__bookDate="+accountDetails.bookDate;
           
            
            //AM - 28/09/2020 - Ebury Accounts
            if(this.accountDetails.codigoCorporate){
                url = url + "&c__codigoCorporate="+this.accountDetails.codigoCorporate;
            }
            ...
            if(this.accountDetails.associatedAccountList){
                url = url + "&c__associatedAccountList="+JSON.stringify(this.accountDetails.associatedAccountList);
            }
