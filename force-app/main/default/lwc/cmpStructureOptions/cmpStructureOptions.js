...
import STR_Groups from '@salesforce/label/c.STR_Groups';
...
import retrieveGroups  from '@salesforce/apex/STR_ControllerStructurals.retrieveGroups';
...
export default class ModalPopupLWC extends LightningElement {
    ...
    @wire(retrieveGroups) apexMethod;
    ...
    updateGroups(event) {
        this.isLoading = true;
        retrieveGroups({accountId: this.parameters.c__accountId})
        .then(result => {
            let self = this;
            if(result.success == true){
                if(result.value != null && result.value.companyId != null){
