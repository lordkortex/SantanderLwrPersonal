    ...
    if (this.userdateformat != undefined) {
      ...
      this.template
        ...
        .onCallApex({
          ...
          controllermethod: "getUserDateFormat",
    ...
    if (this.dateString != "N/A" && this.dateString != undefined) {
      if (this.converttousertimezone) {
        this.dateToFormat = new Date(
          ...
          parseInt(this.dateString.substring(5, 7)) - 1,
          this.dateString.substring(8, 10),
          this.dateString.substring(11, 13),
          this.dateString.substring(14, 16),
          0,
          0
        );
        this.dateToFormat.setMinutes(
          this.dateToFormat.getMinutes() - this.dateToFormat.getTimezoneOffset()
        );
