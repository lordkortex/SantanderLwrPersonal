...
export default class Lwc_statementMovementsParent extends LightningElement {
        ...
        switch (sParameterName[0]) {
          case "c__acountCode":
            sParameterName[1] === undefined
              ? "Not found"
              : (accountinfo.accountCode = sParameterName[1]);
            break;
          case "c__acountName":
            sParameterName[1] === undefined
              ? "Not found"
              : (accountinfo.accountName = sParameterName[1]);
            break;
          case "c__bankName":
            sParameterName[1] === undefined
              ? (accountinfo.bankName = "")
              : (accountinfo.bankName = sParameterName[1]);
            break;
          case "c__subsidiaryName":
            console.log(sParameterName[1]);
            sParameterName[1] === undefined
              ? (accountinfo.subsidiaryName = "")
              : (accountinfo.subsidiaryName = sParameterName[1]);
            break;
          case "c__accountNumber":
            sParameterName[1] === undefined
              ? "Not found"
              : (accountinfo.accountNumber = sParameterName[1]);
            break;
          case "c__accountCurrency":
            sParameterName[1] === undefined
              ? "Not found"
              : (accountinfo.accountCurrency = sParameterName[1]);
            break;
          case "c__valueDate":
            sParameterName[1] === undefined
              ? "Not found"
              : (this.extractDate = sParameterName[1]);
            break;
          case "c__userNumberFormat":
            sParameterName[1] === undefined
              ? "Not found"
              : (userInfo.userNumberFormat = sParameterName[1]);
            break;
          case "c__userDateFormat":
            sParameterName[1] === undefined
              ? "Not found"
              : (userInfo.userDateFormat = sParameterName[1]);
            break;
          case "c__bookBalance":
            sParameterName[1] === undefined
              ? "Not found"
              : (this.closeringBalance_Formatted = sParameterName[1]);
            break;
          case "c__valueBalance":
            sParameterName[1] === undefined
              ? "Not found"
              : (this.openingBalance_Formatted = sParameterName[1]);
            break;
        }
      }
  ...
  setMovementList(response) {
    ...
    this.movementslist =
      response.balances.transactions.listaObtTransacciones[0];
  ...
  movements() {
    ...
    searchMovements({ accountCode: accountCode, dateToSearch: extracDate })
      .then((result) => {
        console.log("OK");
        console.log(result);
