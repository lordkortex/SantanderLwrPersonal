...
export default class Lwc_bakcFrontGPITrackerTable extends NavigationMixin(LightningElement) {
        ...
        try {
            ...
            if(event.target.id != null && event.target.id != "" && event.target.id != undefined){
                ...
                if (sorted != undefined && sorted !=null){
                    ...
                    // }
                    this.template.querySelector('c-lwc_pagination').buildData(this.currentPage);
                }
            }
        ...
        try {
            ...
            .then(result => {
                ...
                if(res != null && res != undefined  && Object.keys(res).length>0){
                    ...
                    this.template.querySelector("c-lwc_pagination").setPagesNumber(toDisplay);
    ...
    openPaymentDetails (event) {
        ...
        var url='c__paymentId='+element.paymentDetail.paymentId+'&c__valueDate='+element.paymentDetail.valueDate+'&c__reason='+element.paymentDetail.transactionStatus.reason+'&c__status='+element.paymentDetail.transactionStatus.status
        +'&c__orderingAccount='+element.paymentDetail.originatorData.originatorAccount.accountId+'&c__orderingBIC='+element.paymentDetail.originatorAgent.agentCode+'&c__orderingBank='+element.paymentDetail.originatorAgent.agentName
        +'&c__beneficiaryAccount='+element.paymentDetail.beneficiaryData.creditorCreditAccount.accountId+'&c__beneficiaryName='+element.paymentDetail.beneficiaryData.beneficiaryName+'&c__beneficiaryBank='+element.paymentDetail.beneficiaryData.creditorAgent.agentName
        +'&c__beneficiaryBIC='+element.paymentDetail.beneficiaryData.creditorAgent.agentCode+'&c__amount='+element.paymentDetail.paymentAmount.amount
        +'&c__currency='+element.paymentDetail.paymentAmount.tcurrency+'&c__beneficiaryCity='+element.paymentDetail.beneficiaryData.creditorAgent.agentLocation
        +'&c__beneficiaryCountry='+element.paymentDetail.beneficiaryData.creditorAgent.agentCountry;
        console.log(url);
    ...
    handleDisplayAmount (event){
        ...
        var amountComplete = (event.detail.whole + event.detail.decimal + ' ' + event.detail.currency);
