...
export default class Lwc_swiftPaymentTableRow extends NavigationMixin(
  LightningElement
) {
  label = {
    trackingDetails,
  ...
  get getAccounIdBeneficiary() {
    return this.item.paymentDetail.beneficiaryData.creditorCreditAccount
      .accountId;
  }
  ...
  openPaymentDetails() {
    ...
    var url =
      "c__paymentId=" +
      this.item.paymentDetail.paymentId +
      "&c__valueDate=" +
      this.item.paymentDetail.valueDate +
      "&c__reason=" +
      this.item.paymentDetail.transactionStatus.reason +
      "&c__status=" +
      this.item.paymentDetail.transactionStatus.status +
      "&c__orderingAccount=" +
      this.item.paymentDetail.originatorData.originatorAccount.accountId +
      "&c__orderingBIC=" +
      this.item.paymentDetail.originatorAgent.agentCode +
      "&c__orderingBank=" +
      this.item.paymentDetail.originatorAgent.agentName +
      "&c__beneficiaryAccount=" +
      this.item.paymentDetail.beneficiaryData.creditorCreditAccount.accountId +
      "&c__beneficiaryName=" +
      this.item.paymentDetail.beneficiaryData.beneficiaryName +
      "&c__beneficiaryBank=" +
      this.item.paymentDetail.beneficiaryData.creditorAgent.agentName +
      "&c__beneficiaryBIC=" +
      this.item.paymentDetail.beneficiaryData.creditorAgent.agentCode +
      "&c__amount=" +
      this.item.paymentDetail.paymentAmount.amount +
      "&c__currency=" +
      this.item.paymentDetail.paymentAmount.tcurrency +
      "&c__beneficiaryCity=" +
      this.item.paymentDetail.beneficiaryData.creditorAgent.agentLocation +
      "&c__beneficiaryCountry=" +
      this.item.paymentDetail.beneficiaryData.creditorAgent.agentCountry;
    console.log(url);
