    ...
    try {
      ...
      if (urlParams[0] === "params") {
        ...
        this.getURLParams(urlParams).then((result) => {
          ...
          if (
            this.template.querySelector("c-lwc_ipt-filters") != undefined &&
            this.template.querySelector("c-lwc_ipt-filters") != null
          ) {
    ...
    if (sURLVariables[0] != "") {
      for (var i = 0; i < sURLVariables.length; i++) {
        ...
        if (sParameterName[0] === "c__subsidiaryName") {
          ...
          sParameterName[1] === undefined
            ? "Not found"
            : (this.fullaccountlist = sParameterName[1]);
        }
      }
