    ...
    add : function(component, event, helper){
        try {
            if(component.get("v.selectedAccount")!='' && component.get("v.selectedChannel")!=''){
                ...
                var body='{"accountPain002Insert": {"companyGlobalId": "'+component.get("v.entity")+'","accountId": "'+component.get("v.selectedAccount")+'","bankId": "'+bic+'","channel": "'+component.get("v.selectedChannel")+'","periodicity": "daily"}}';
