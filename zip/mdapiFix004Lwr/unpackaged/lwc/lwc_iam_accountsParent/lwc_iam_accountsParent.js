...
//api vs track ?
    ...
    get rGlobalBalanceCurrencyListNotEmpty(){
        return this.rGlobalBalance != null && this.rGlobalBalance.currencyList.length != 0;
            ...
            for(var i = 0; i < urlParams.length ; i++) {
                ...
                switch(sParameterName[0]) {
                    ...
                    case("c__firstTAccountCountryList"):
                        ...
                        sParameterName[1] === undefined ? 'Not found' : this.firsttaccountcountrylistjson = sParameterName[1];
                        break;
                    case("c__firstAccountCountryList"):
                        ...
                        sParameterName[1] === undefined ? 'Not found' : this.firstaccountcountrylistjson = sParameterName[1];
                        break;
    ...
    setComponentInitialDataUpdate(iReturn, divisa){
        ...
        this.globalavailablebalance = iReturn.currencyGlobalBalance[currentCurrency][1];
    ...
    */
    ...
    fileToDonwload() { 
        ...
        if(this.template.querySelector('c-lwc_download-accounts-lu') != null){
            this.template.querySelector('c-lwc_download-accounts-lu').downloadAccounts();
        }
    }
    ...
    */
    ...
    handleExpand(){   
        this.template.querySelectorAll("c-lwc_child-accounts-list").forEach(child =>{
            child.handleExpand();
        });
    }
