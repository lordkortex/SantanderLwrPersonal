...
export default class Lwc_calendar extends NavigationMixin(LightningElement) {
  ...
  @track updatedHour;
  @track showDetails =
    "iElement container slds-hide slds-card__header slds-grid contentAccount";
  ...
  connectedCallback() {
    ...
    //SNJ - 15/04/2020
    if (
      account.lastUpdateAvailableBalance != null &&
      account.lastUpdateAvailableBalance != "" &&
      account.lastUpdateAvailableBalance != undefined &&
      typeof account.lastUpdateAvailableBalance != "undefined"
    ) {
      account.lastUpdateAvailableBalanceDate = account.lastUpdateAvailableBalance.split(
        ","
      )[0];
      account.lastUpdateAvailableBalanceTime = account.lastUpdateAvailableBalance.split(
        ","
      )[1];
    ...
    this.onetradeandtransall =
      this.isonetrade && this.iaccount.transactionsAllowed;
    this.onetradeandnottransall =
      this.isonetrade && !this.iaccount.transactionsAllowed;
    this.noonetradeoronetradeandtransall =
      !this.isonetrade ||
      (this.isonetrade && this.iaccount.transactionsAllowed);
    this.noonetradeoronetradeandballsall =
      !this.isonetrade || (this.isonetrade && this.iaccount.balanceAllowed);
    this.swiftandtab =
      this.iaccount.hasSwiftPayments == "YES" &&
      this.itabselected != "EndOfDayTab";
    this.swiftandint =
      this.iaccount.hasSwiftPayments == "true" &&
      this.iaccount.internationalPaymentsAllowed == true;
  ...
  goToAccountTransactions() {
    ...
    var url =
      ...
      aux +
      "&c__subsidiaryName=" +
      this.iaccount.subsidiaryName +
      "&c__accountNumber=" +
      this.iaccount.displayNumber +
      "&c__bank=" +
      this.iaccount.bankName +
      "&c__mainAmount=" +
      this.iaccount.amountMainBalance +
      "&c__availableAmount=" +
      this.iaccount.amountAvailableBalance +
      "&c__currentCurrency=" +
      this.iaccount.currencyCodeAvailableBalance +
      "&c__alias=" +
      this.iaccount.alias +
      "&c__idType=" +
      this.iaccount.idType +
      "&c__lastUpdate=" +
      this.islastupdate +
      "&c__country=" +
      this.iaccount.country +
      "&c__aliasBank=" +
      this.iaccount.bankName +
      "&c__bic=" +
      this.iaccount.bic +
      ...
      this.iaccount.codigoCuenta +
      "&c__bookDate=" +
      this.iaccount.lastUpdateAvailableBalance +
      "&c__valueDate=" +
      this.iaccount.valueDate +
      "&c__codigoBic=" +
      this.iaccount.codigoBic +
      "&c__codigoEmisora=" +
      this.iaccount.codigoEmisora +
      "&c__aliasEntidad=" +
      this.iaccount.aliasEntidad +
      "&c__codigoCuenta=" +
      this.iaccount.codigoCuenta +
      "&c__countryName=" +
      this.iaccount.countryName +
      "&c__accountsFilters=" +
    ...
    if (this.iaccount.associatedAccountList) {
      url =
        ...
        JSON.stringify(this.iaccount.associatedAccountList);
    }
  ...
  goToSwiftTracking() {
    ...
    var url =
      ...
      "&c__bic=" +
      this.iaccount.bic +
      this.iaccount.paisbic +
      this.iaccount.locatorbic +
      this.iaccount.branch +
      "&c__currentCurrency=" +
      this.iaccount.currencyCodeAvailableBalance +
      "&c__accountNumber=" +
      this.iaccount.displayNumber +
      "&c__idType=" +
      this.iaccount.c__idType +
      "&c__updateHour=" +
      this.updatedHour +
      "&c__date=" +
      this.iaccount.lastUpdateAvailableBalanceDate +
      "&c__bank=" +
      this.iaccount.bankName +
      "&c__mainAmount=" +
      this.iaccount.amountMainBalance +
  ...
  doExpand() {
    if (this.showAccountBalanceAllowed) {
      ...
      this.showDetails =
        "iElement container slds-card__header slds-grid contentAccount";
    }
  }
