({
  initComponent: function (component, event, helper) {
    new Promise(
      ...
      .then(
        $A.getCallback(function (value) {
          return helper.getAccountsToB2BOrigin(
            component,
            helper,
            component.get("v.userData"),
      ...
      .then(
        $A.getCallback(function (value) {
          return helper.getNavigatorInfo(component, helper);
        })
      )
      .catch(
  ...
  handleCompleteStep: function (component, event, helper) {
    ...
    if (confirm == true) {
      helper
        .getBeneficiaryAccounts(component, helper)
        .then(
          $A.getCallback(function (value) {
            return helper.continuePaymentInformation(component, event, helper);
          })
        )
        .then(
          $A.getCallback(function (value) {
  ...
  /*handleCompleteStep: function (component, event, helper) {
        let confirm = event.getParam('confirm');
        if (confirm == true) {
            helper.getBeneficiaryAccounts(component, helper).then($A.getCallback(function (value) {
                return continuePaymentInformation(component, event, helper);
        ...
        .then(
          $A.getCallback(function (value) {
            if (step == 1) {
              ...
              return helper.getAccountsToB2BDestination(
                component,
                helper,
                userData,
                transferType,
