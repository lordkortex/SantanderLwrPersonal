                  ...
                  for (var i = 0; i < sURLVariables.length; i++) {
                    ...
                    switch (sParameterName[0]) {
                      ...
                      case "c__paymentID":
                        sParameterName[1] === undefined
                          ? "Not found"
                          : component.set("v.paymentID", sParameterName[1]);
                        break;
                    }
                  }
              ...
              if (stateRV.success) {
                if (feesBoolean == true) {
                  ...
                  if (!$A.util.isEmpty(stateRV.value.exchangeRate)) {
                    ...
                    payment.operationNominalFxDetails.customerExchangeRateDRAFT =
                  ...
                  if (!$A.util.isEmpty(stateRV.value.convertedAmount)) {
                    payment.convertedAmountDRAFT =
                      stateRV.value.convertedAmount;
                    payment.amountOperativeDRAFT =
                      stateRV.value.convertedAmount;
