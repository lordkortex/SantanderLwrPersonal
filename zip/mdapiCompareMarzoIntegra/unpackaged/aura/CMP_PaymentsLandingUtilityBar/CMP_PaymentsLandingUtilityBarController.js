({
  ...
  reuse: function (component, event, helper) {
    helper.getPaymentDetails(component, event, helper).then(
      $A.getCallback(function (value) {
              ...
              .then(
                $A.getCallback(function (value) {
                  ...
                  if (!$A.util.isEmpty(payment.fees)) {
                    total =
                      parseFloat(payment.amountSend) + parseFloat(payment.fees);
                  } else {
                  ...
                  if (!$A.util.isEmpty(paymentId)) {
                    url =
                      ...
                      "&c__paymentDetails=" +
                      JSON.stringify(component.get("v.paymentDetails"));
                  }
  ...
  handleDiscard: function (component, event, helper) {
    ...
    return helper
      .discard(component, event, helper)
      .then(
        $A.getCallback(function (value) {
          helper.sendToLanding(component, event, helper, variable, true);
        })
