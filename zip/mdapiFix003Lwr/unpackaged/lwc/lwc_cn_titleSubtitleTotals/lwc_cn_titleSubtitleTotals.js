...
export default class Lwc_cn_titleSubtitleTotals extends LightningElement {
  ...
  get bookDateNotNull() {
    return (
      this.accountdetails.bookDate != null &&
      (this.accountdetails.dateValue != "N/A" ||
        (this.accountdetails.dateValue == "N/A" &&
          this.accountdetails.bookBalance != "0"))
    );
  }
  ...
  get getAccountDetails() {
    return (
      ...
      " - " +
      this.accountdetails.accountCurrency +
      " " +
  ...
  get getAccountNumber() {
    return (
      this.accountdetails.currency + " " + this.accountdetails.accountNumber
    );
  }
  ...
  navigateToAccountDetails() {
    ...
    var url =
      ...
      "&c__codigoEmisora=" +
      this.accountdetails.codigoEmisora +
      "&c__aliasEntidad=" +
      this.accountdetails.aliasEntidad +
      "&c__bookDate=" +
      this.accountdetails.bookDate;
    this.template
      .querySelector("c-lwc_service-component")
      .redirect({ page: "account-detail-transaction", urlParams: url }); //;redirect("account-detail-transaction",url);
  }
}
