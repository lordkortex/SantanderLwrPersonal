...
export default class Lwc_globalExchangeRatesSingle extends LightningElement {
      ...
      for (var i in this.exchangeratesshow) {
        ...
        if (str == "1") {
          ...
          window.localStorage.setItem(
            ...
            this.exchangeratesshow[i].divisa
          );
        }
      }
  ...
  updateExchageRates(e) {
    ...
    if (
      this.template.querySelector("c-lwc_child-global-exchange-rates-single") !=
        undefined &&
      this.template.querySelector("c-lwc_child-global-exchange-rates-single") !=
        null
    ) {
      this.template
        .querySelectorAll("c-lwc_child-global-exchange-rates-single")
        .forEach((element) => {
