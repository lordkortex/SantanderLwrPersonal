      ...
      if (isIngested) {
        if (this.comesfromtracker == true) {
          ...
          UETRSearchResult.initiationTime === undefined
            ? "Not found"
            : (this.iobject.valueDate = UETRSearchResult.initiationTime);
    ...
    try {
      return new Promise((resolve, reject) => {
        getSteps({
          ...
          .then((result) => {
            ...
            if (res != "" && res != undefined && res != null) {
              ...
              if (
                ...
                iobj.beneficiaryCountryName =
                  res.creditorAgent.agentCountryName;
          ...
          .catch((error) => {
            console.log(
              "### lwc_iptDetailParent ### getDataStepsTry() ::: Error: " +
                error
            );
            this.showerror = true;
            this.dispatchErrorLoadEvent();
