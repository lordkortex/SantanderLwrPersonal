...
export default class Lwc_iptPagination extends LightningElement {
  ...
  get lastPage() {
    if (this.pageList) {
      return (
        this.pageList.length - 2 >= this.currentPageInt &&
  ...
  get getPage() {
    if (this.pageList) {
      return (
        (this.pageList.length > this.currentPageInt + this.pagesToShow - 1 ||
          this.currentPageInt == this.end) &&
        this.currentPageInt != this.pageList.length
      );
    }
  }
  ...
  get getcurrentPageInt() {
    if (this.pageList) {
      return (
        this.pageList.length > 1 && this.pageList.length != this.currentPageInt
      );
    }
  }
